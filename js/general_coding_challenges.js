...
//     Objective: Write a script to generate and output the first 25 narcissistic integers.
    function narcissistNumber(maxCount) {
        ...
        let count = 1; //sets count as zero, as we haven't found any yet.
        ...
        do {
            ...
            for (let digit of digitArray) {
                y += Math.pow(digit,m); // for each digit in the array raises the individual digit to the power of the amount of numbers that compose the number and adds it to the local variable y
                }
